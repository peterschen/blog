...
-- c4n-highcpu-96: 192 GiB
-- c4-highcpu-96:  192 GiB
...
ALTER DATABASE [demo4_${i}] SET TARGET_RECOVERY_TIME = 200 MINUTES;
ALTER DATABASE [demo4_${i}] SET AUTO_UPDATE_STATISTICS OFF;
ALTER DATABASE [demo4_${i}] SET DELAYED_DURABILITY = DISABLED WITH NO_WAIT;

-- c4n-highcpu-96: 96 (88 visible, 2 vNUMA) vCPUs
-- c4-highcpu-96:  96 (88 visible, 2 vNUMA) vCPUs
-- c3-highcpu-88:  88 (88 visible, 2 vNUMA) vCPUs
